    ...
    return (
      ...
      >
        <button
          ...
          className={`w-[56px] h-[56px] rounded-[12px] flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden ${app.id === "dashboard" ? "bg-white rounded-sm p-1" : "bg-white/5 border border-white/5"} bg-transparent`}
...
export const IpadosAppGrid = memo(
  ({ apps, onAppClick, getAppLabel }: IpadosAppGridProps) => {
