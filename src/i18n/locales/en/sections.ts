    ...
    items: [
      {
        name: "Axosmoney",
        description:
          "A comprehensive application for uploading receipts, managing suppliers, invoicing, integrating third-party services with SAP Concur, and a rewards program with Amazon Business.",
