export const settingsEn = {
  ...
  appearance: {
    ...
    finderClickToOpenDesc:
      "Choose whether to open files with a single click or a double click.",
  ...
  battery: {
    title: "Battery",
    health: "Battery State",
    charging: "Charging",
    onBatteryPower: "On Battery Power",
    calculating: "Calculating...",
    timeRemaining: "Time Remaining",
    timeUntilFull: "Estimated time until full",
    usageTime: "Estimated usage time",
    fullyCharged: "Fully Charged",
    hoursAndMins: "{{hrs}} h {{mins}} min",
    onlyMins: "{{mins}} min",
    cycles: "Power Source",
    cyclesDesc: "Current energy delivery",
    energySaver: "Low Power Mode",
    energySaverDesc: "Reduces energy usage to increase battery life.",
  },
  wifi: {
