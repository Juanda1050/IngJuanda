...
export function DashboardWindow() {
  ...
  const technologies = [
    ...
    {
      name: "Scrum",
      icon: <Users className="size-5 text-[#FFB020]" />,
      level: t("dashboard.levelExpert"),
      color: "from-[#FFB020]/20 to-[#FFB020]/5",
    },
    {
      name: "SAP Concur",
      icon: <Workflow className="size-5 text-[#008FD3]" />,
      level: t("dashboard.levelAdvanced"),
      color: "from-[#008FD3]/20 to-[#008FD3]/5",
    },
    {
      name: "SQL",
      icon: <Database className="size-5 text-[#336791]" />,
      level: t("dashboard.levelAdvanced"),
      color: "from-[#336791]/20 to-[#336791]/5",
    },
    {
      name: "Figma",
      icon: <SiFigma className="size-5 text-[#F24E1E]" />,
      level: t("dashboard.levelAdvanced"),
      color: "from-[#F24E1E]/20 to-[#F24E1E]/5",
    },
    {
      name: t("dashboard.techResponsiveDesign"),
      icon: <MonitorSmartphone className="size-5 text-[#06B6D4]" />,
      level: t("dashboard.levelExpert"),
      color: "from-[#06B6D4]/20 to-[#06B6D4]/5",
    },
    {
      name: "Node.js",
      icon: <FaNodeJs className="size-6 text-[#5FA04E]" />,
      level: t("dashboard.levelAdvanced"),
      color: "from-[#5FA04E]/20 to-[#5FA04E]/5",
    },
    {
      name: ".NET",
      icon: <SiDotnet className="size-6 text-[#512BD4]" />,
      level: t("dashboard.levelAdvanced"),
      color: "from-[#512BD4]/20 to-[#512BD4]/5",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/40 pb-5">
          <div className="space-y-1">
            <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight flex items-center gap-2">
              ...
              <span>{formatWithAppleEmojis(t("dashboard.title"))}</span>
            </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-6">
              ...
              <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                <div className="relative">
                  ...
                  <img
                    src="/profile.jpg"
                    alt="Juan Daniel"
                    className="relative size-24 sm:size-28 md:size-32 lg:size-36 rounded-full object-cover border-2 border-background shadow-md select-none pointer-events-none"
                    onError={(e) => {
                      // Fallback if image fails to load
                      e.currentTarget.src =
                        "https://github.com/identicons/juan.png";
                    }}
                  />
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                {
                  label: t("dashboard.experienceTitle"),
                  val: t("dashboard.experienceValue"),
                  bg: "from-blue-500/10 to-indigo-500/5 border-blue-500/15",
                },
                {
                  label: t("dashboard.projectsTitle"),
                  val: t("dashboard.projectsValue"),
                  bg: "from-emerald-500/10 to-teal-500/5 border-emerald-500/15",
                },
                {
                  label: t("dashboard.specialtyTitle"),
                  val: t("dashboard.specialtyValue"),
                  bg: "from-purple-500/10 to-pink-500/5 border-purple-500/15",
                },
                {
                  label: t("dashboard.cvTitle"),
                  val: t("dashboard.cvValue"),
                      ...
                      {stat.val.split("/").map((lang, lIdx) => {
                        ...
                        if (match) {
                          ...
                          return (
                            <div
                              key={lIdx}
                              className="flex items-center justify-between text-xs gap-1.5 w-full"
                            >
              ...
              <CardContent className="p-5 space-y-4">
                <div>
                  <h3 className="text-sm font-extrabold tracking-tight flex items-center gap-1.5 text-foreground">
                    ...
                    <span>
                      {formatWithAppleEmojis(t("dashboard.softSkills"))}
                    </span>
                  </h3>
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    {t("dashboard.softSkillsDesc")}
                  </p>
                </div>
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        hoveredTech === tech.name
                          ? "shadow-sm border-border/70 scale-[1.02]"
                          : "",
                      )}
                    >
